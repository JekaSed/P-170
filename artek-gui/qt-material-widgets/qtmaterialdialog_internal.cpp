...
QtMaterialDialogProxy::QtMaterialDialogProxy(QtMaterialDialogWindow* source, QStackedLayout* layout,
                                             QtMaterialDialog* dialog, QWidget* parent)
  : QWidget(parent)
  , m_source(source)
  , m_layout(layout)
  , m_dialog(dialog)
...
void QtMaterialDialogWindow::paintEvent(QPaintEvent* event)
{
    ...
    brush.setColor(parentWidget()->palette().color(backgroundRole()));
