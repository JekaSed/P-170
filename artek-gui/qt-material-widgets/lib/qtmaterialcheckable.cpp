...
void QtMaterialCheckablePrivate::init()
{
    ...
    checkedIcon = new QtMaterialCheckableIcon(QIcon(":/materials/icons/toggle/ic_check_box_24px.png"), q);
    uncheckedIcon =
      new QtMaterialCheckableIcon(QIcon(":/materials/icons/toggle/ic_check_box_outline_blank_24px.png"), q);
